    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שובל רוימי אביסרור משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '7cd0b9f2-ac63-41c0-b4b4-ed3052d22d15',
                    name: data.name || '',
                    email: data.email || '',
